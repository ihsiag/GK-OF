...
#ifndef CLASS_NEXT_BUTTON_H  
#define CLASS_NEXT_BUTTON_H
...
public:
	...
	Class_NextButton(ofImage* _img, ofImage** _selectedImg, ofEasyCam* _cam, const glm::vec2& _pos,const glm::vec2& _size) {
		originalImg = _img;
