...
void ofApp::setup() {
    ...
    shared_ptr< ofxBulletBox > box(new ofxBulletBox());
    box->create(world.world, ofVec3f(0, -2.55, 0), 0., 1.75);
    box->enableKinematic();
    box->setFriction(0.8);
    box->add();
    box->getCollisionShape()->setMargin(0.25);
