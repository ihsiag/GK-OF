...
#ifndef CLASS_ZONE_HEAD_TITLE_H  
#define CLASS_ZONE_HEAD_TITLE_H

#include "components/zones/Class_Zone.h"

class Class_HeadTitleZone :public Class_Zone{
...
public:
	...
	Class_HeadTitleZone(const glm::vec2& _zonePos,const glm::vec2& _zoneSize,const string& _title) {
		zonePos = _zonePos;
		zoneSize = _zoneSize;
		title = _title;
	}
