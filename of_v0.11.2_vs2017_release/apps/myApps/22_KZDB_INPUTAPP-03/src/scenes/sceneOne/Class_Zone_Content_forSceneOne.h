...
public:
	...
	Class_ContentZone_forSceneOne(const glm::vec2& _zonePos, const glm::vec2& _zoneSize,SceneAdminInfo* _adminInfo,vector<ofImage>* _prjImgs, vector<string>* _prjIds) {
		zonePos = _zonePos;
		zoneSize = _zoneSize;
