...
#ifndef CLASS_ZONE_INDEX_FOR_SCENE_ONE_H  
#define CLASS_ZONE_INDEX_FOR_SCENE_ONE_H
...
public:
	...
	Class_IndexZone_forSceneOne(const glm::vec2& _zonePos, const glm::vec2& _zoneSize, SceneAdminInfo* _adminInfo) {
		zonePos = _zonePos;
		zoneSize = _zoneSize;
